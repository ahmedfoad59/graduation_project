...
<body> 
    ...
    <div class="main">
        ...
        <div class="search">
            ...
            <button  class="btn-add"> <a href="{{ route('show_student') }}" >   add</a></button> --}}
            <form action="{{route('index_student')}}" method="get">
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                      ...
                      <a href="{{route('show_student')}}" class="btn btn-primary"><i
                              class="fa fa-plus"></i> @lang('site.add')</a>

                  </div>
                </div>
              </form>
  {{-- <a href="{{ route('show_add_course') }}" >   add</a> --}}
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <button class="btn btn-warning me-md-2 w-15"> <a href="{{route('prints',$row->id)}}" class="">print</a> </button>
