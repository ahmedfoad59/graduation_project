...
<html dir="rtl">
    <head>
      <link rel="stylesheet" href="{{ public_path('site_files/css/all.min.css') }}">
      <link rel="stylesheet" href="{{ public_path('site_files/css/bootstrap.min.css') }}">
      <link rel="stylesheet" href="{{ public_path('site_files/css/student_add_course_form/main.css') }}">
...
<script src= "{{ public_path('site_files/Js/bootstrap.bundle.min.js') }}" ></script>
    </body>
</html>
...
<style src= "{{ public_path('site_files/Js/bootstrap.bundle.min.js') }}" ></style>
    </body>
</html> --}}